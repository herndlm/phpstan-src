...
function constantArraysWithOptionalKeys(array $arr): void
{
	...
	$arr;
	$extract = array_splice($arr, 0, 1, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{0: 'hello', b?: 1, c: 2}
	...
	$arr;
	$extract = array_splice($arr, 1, 1, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{a: 0, 0: 'hello', c: 2}|array{b: 1, 0: 'hello'}
	...
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{a?: 0, b: 1, 0: 'hello', c: 2}
	assertType('array{}', $extract);
	...
	$arr;
	$extract = array_splice($arr, 0, -1, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{0: 'hello', c: 2}
	assertType('array{a?: 0, b: 1}', $extract);
	...
	$arr;
	$extract = array_splice($arr, 1, 1, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{a: 0, 0: 'hello', c?: 2}
	assertType('array{b?: 1, c?: 2}', $extract);
	...
	$arr;
	$extract = array_splice($arr, 0, -1, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\', 0|1|2|\'hello\'>', $arr); // Could be array{0: 'hello', b: 1}|array{0: 'hello', c: 2}
	assertType('array{a: 0, b?: 1}', $extract);
	...
	$arr;
	$extract = array_splice($arr, 1, 2, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\'|\'d\', 0|1|2|3|\'hello\'>', $arr); // Could be array{a: 0, 0: 'hello', d?: 3}
	...
	$arr;
	$extract = array_splice($arr, -2, 2, ['hello']);
	assertType('non-empty-array<0|\'a\'|\'b\'|\'c\'|\'d\', 0|1|2|3|\'hello\'>', $arr); // Could be array{a?: 0, b?: 1, 0: 'hello'}
